...
COMMENT ON COLUMN shop.client.pactronymic	IS 'Отчество клиента';
...
(
	...
	-- кроме существования книги и категории цены должна цуществовать цена как таковая!
	CONSTRAINT fk_order_detail_price FOREIGN KEY (book_id, price_category_no)
	REFERENCES book_store.price (book_id, price_category_no)
...
BEGIN
	...
	INSERT INTO genre (genre_name, parent, genre_code)
	VALUES ('Компьютеры и программирования', techn_book_id, '5.1')
...
INSERT INTO shop.client (client_login, firstname, pactronymic, lastname, email, phone, delivery_addr)
